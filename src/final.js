export const questions = [
  ...
  },
  {
    ...
    },
    {
      id: 3,
      question:
        "Ecology is the scientific study of ___ that determine the distribution and abundance of organisms.",
    ...
    },
    {
      id: 10,
      question:
        "Ecology is the scientific study of interactions among organisms and their ___.",
  ...
  },
  {
    id: 25,
    question:
      "Observing a bird take a tick out of another bird's head and eat it is an example of",
  ...
  },
  {
    id: 43,
    question:
      "___ employs a simple rule of selecting every kth unit starting with a number chosen at random from 1 to k as the random start.",
    options: [
  ...
  {
    id: 29,
    question: "An inventory of behaviours exhibited by an animal is called",
    options: ["ecogram", "ethogram", "behaviourogram", "animalogram"],
    answer: "ethogram",
  },
  {
    id: 16,
    question: "The diversity within an ecosystem is known as",
    options: [
  ...
  {
    id: 27,
    question: "Trampling of grass due to animal movement is an example of",
  ...
  },
  {
    id: 87,
    question:
      "___ determines which projects or developments require a full or partial impact assessment study.",
  ...
  },
  {
    id: 22,
    question:
      "Observing a monkey take a tick out of another monkey's head and eat it is an example of",
    options: ["tick hunting", "auto grooming", "allo grooming", "foraging"],
    answer: "allo grooming",
  },
  {
  ...
  {
    id: 17,
    question: "The diversity among different geographies is known as",
    options: [
      "alpha (α) biodiversity",
      "beta (β) biodiversity",
      "gamma (γ) biodiversity",
  ...
  },
  {
    id: 11,
    question:
      "Hierarchy emerges almost inevitably through a variety of evolutionary processes. Why?",
  ...
  },
  {
    id: 26,
    question:
      "Interaction between exotic shrubs and trees through seed predators is an example of",
    options: [
...
// import fs from "fs";
// // const fs = require("fs");
// fs.writeFileSync("./hello.txt", JSON.stringify(questions), "utf-8");
